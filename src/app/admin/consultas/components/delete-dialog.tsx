...
import { deleteConsulta } from '@/app/actions/upsertConsulta';
...
export const DeleteConsultaDialog = ({ id, paciente, data }: DeleteConsultaDialogProps) => {
            ...
            <DialogContent className="sm:max-w-md">
                <DialogHeader>
                    ...
                    <DialogDescription className="pt-2 text-left">
                        Você tem certeza que deseja excluir a consulta de{' '}
                        <span className="text-foreground font-semibold">{paciente}</span> em{' '}
